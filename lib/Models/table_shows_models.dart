...
//
//     final tableshows = tableshowsFromJson(jsonString);

import 'dart:convert';

List<Tableshows> tableshowsFromJson(String str) => List<Tableshows>.from(json.decode(str).map((x) => Tableshows.fromJson(x)));

String tableshowsToJson(List<Tableshows> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
...
class Tableshows {
    ...
    factory Tableshows.fromJson(Map<String, dynamic> json) => Tableshows(
        id: json["id"],
        url: json["url"],
        name: json["name"],
